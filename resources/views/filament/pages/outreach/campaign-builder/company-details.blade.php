                                ...
                                <template x-for="agent in campaignBuilderAiAgentOptions()" :key="`campaign-creation-agent-${agent.id}`">
                                    ...
                                    >
                                        ...
                                        <span class="flex shrink-0 items-center gap-1">
                                            ...
                                            <button
                                                type="button"
                                                x-on:click.stop="deleteCampaignCreationAiAgent(agent)"
                                                ...
                                                :class="canDeleteCampaignCreationAiAgent(agent.id) ? 'text-gray-400 hover:bg-red-50 hover:text-red-600' : 'cursor-not-allowed text-gray-300'"
