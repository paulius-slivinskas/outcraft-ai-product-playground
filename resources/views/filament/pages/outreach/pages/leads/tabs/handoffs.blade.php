        ...
        <section data-card-surface x-cloak x-show="activeNav === 'Leads' && activeTab === 'Handoffs' && ! leadDetailOpen" class="mx-6 mb-6 mt-4 overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-gray-900/5">
            <div class="overflow-x-auto max-sm:overflow-visible">
                <table class="w-full border-collapse text-sm max-sm:block sm:min-w-[860px] sm:table-fixed">
                    <colgroup>
                        <col class="w-1/2">
                        <col>
                        <col>
                    ...
                    <tbody class="max-sm:block">
                        ...
                        <template x-for="(row, rowIndex) in loadingRows()" :key="'handoff-' + row.name + row.phone + row.email + row.age">
                            <tr x-on:click="openLeadDetails(row)" class="cursor-pointer transition-colors hover:bg-gray-50 max-sm:grid max-sm:grid-cols-2 max-sm:items-start max-sm:gap-x-4 max-sm:gap-y-4 max-sm:px-4 max-sm:py-4" :class="rowIndex === loadingRows().length - 1 ? '' : 'border-b border-gray-100'">
                                <td class="px-6 py-4 align-top max-sm:col-span-2 max-sm:block max-sm:p-0">
                                    <span x-show="row.name" class="group relative inline-flex h-[26px] max-w-full items-center">
                                ...
                                <td class="px-4 py-4 align-top max-sm:block max-sm:min-h-[56px] max-sm:p-0">
                                    ...
                                    <span class="group relative mt-1 flex h-[26px] max-w-full items-center text-xs text-gray-500">
                                ...
                                <td class="px-4 py-4 align-top text-right max-sm:block max-sm:min-h-[56px] max-sm:p-0 max-sm:text-left">
                                ...
                                <td class="w-[128px] py-4 pr-6 pl-3 align-middle text-right max-sm:col-span-2 max-sm:flex max-sm:w-auto max-sm:items-center max-sm:p-0">
                                    <button type="button" x-on:click.stop class="inline-flex h-9 items-center justify-center rounded-md bg-white px-4 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 transition hover:bg-gray-50">Resolve</button>
                                </td>
                            </tr>
                        </template>
